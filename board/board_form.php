...
<head>
	...
	<script src="http://<?= $_SERVER['HTTP_HOST'] ?>/test_myhome/board/js/board.js"></script>
...
<body>
	...
	<section>
		...
		<div id="board_box">
			...
			<form name="board_form" method="post" action="dmi_board.php?mode=insert" enctype="multipart/form-data">
				<ul id="board_form">
					<li>
