...
<head>
	...
	<link rel="stylesheet" type="text/css" href="http://<?= $_SERVER['HTTP_HOST'] ?>/test_myhome/board/css/board.css">
...
<body>
	...
	<section>
		...
		<div id="board_box">
			...
			?>
			<form name="board_form" method="post" action="dmi_board.php?num=<?= $num ?>&page=<?= $page ?>&mode=modify" enctype="multipart/form-data">
				<ul id="board_form">
					<li>
